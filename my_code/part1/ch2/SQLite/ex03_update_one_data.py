...
if __name__ == '__main__':
    con = connect_sqlite()
    update_one(con=con, table_name='chechup', search_id=1, search_field_name='Name', update_value='Roh')
    update_one(con=con, table_name='chechup', search_id=1, search_field_name='Height', update_value='165cm')
    update_one(con=con, table_name='chechup', search_id=1, search_field_name='Weight', update_value='53kg')
    update_one(con=con, table_name='chechup', search_id=1, search_field_name='Measured_data', update_value='2023/06/21')
