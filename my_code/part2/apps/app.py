...
def create_app(config_key):
    ...
    # blueprint 등록시(register_blueprint) url_prefix를 세팅하지 않기 때문에,
    # apps.detector.views.py 에서 Blueprint 생성시, static은 지정X
    app.register_blueprint(dt_views.dt)

    # 커스텀 오류 화면을 등록한다
    # register_error_handler(오류코드 or 오류 클래스, 실행 하는 함수)
